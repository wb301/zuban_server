...
$runtimePath = 'Youfan/'; //自定义修改 与convention.php DEFAULT_MODULE 必须一致
...
defined('LOG_PATH')     or define('LOG_PATH',       RUNTIME_PATH.'Logs_'.$runtimePath); // 应用日志目录
defined('TEMP_PATH')    or define('TEMP_PATH',      RUNTIME_PATH.'Temp_'.$runtimePath); // 应用缓存目录
defined('DATA_PATH')    or define('DATA_PATH',      RUNTIME_PATH.'Data_'.$runtimePath); // 应用数据目录
defined('CACHE_PATH')   or define('CACHE_PATH',     RUNTIME_PATH.'Cache_'.$runtimePath); // 应用模板缓存目录
