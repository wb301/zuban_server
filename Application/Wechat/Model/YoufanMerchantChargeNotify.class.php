 ...
 *
 */
class YoufanMerchantChargeNotify extends WxPayNotify
{
...
//        }
    ...
    {
        Log::record('wx charge call back data:'.json_encode($data),Log::INFO,true);
        $para = array(
            'order_no'=>$data['attach'],
            'price' => $data['total_fee']/100,
            'transaction_no' => $data['transaction_id'],
            'from' => 'WX'
        );
        OrderModel::merchantChargeOrder($para);
    }
